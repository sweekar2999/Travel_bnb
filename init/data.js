const sampleListings = [
  ...
  },
  {
    ...
    description:
      "Experience the vibrant culture of Tokyo from this modern and stylish apartment in the heart of the city.",
    image: "https://images.unsplash.com/photo-1568605114967-8130f3a36994?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8YmVhY2glMjB2YWNhdGlvbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
    price: 2200,
    location: "Tokyo",
    country: "Japan",
  },
  {
    ...
    description:
      "Reconnect with nature in this eco-friendly jungle bungalow. Perfect for eco-conscious travelers.",
  ...
  },
  {
    ...
    description:
      "Live like a local in this chic Parisian flat. Explore the city's cafes, shops, and historic sites.",
  ...
  },
  {
    ...
    description:
      "Immerse yourself in Moroccan culture in this traditional riad. Enjoy the vibrant colors and intricate designs.",
  ...
  },
  {
    ...
    description:
      "Experience the ultimate in luxury with a stay on a private yacht. Sail the open seas in style.",
  ...
  },
  {
    ...
    description:
      "Soak up the sun in this stunning seaside villa. Enjoy the breathtaking views of the Mediterranean.",
  ...
  },
  {
    ...
    description:
      "Experience the tranquility of the countryside in this cozy farmhouse. A perfect retreat from the city.",
  ...
  },
  {
    ...
    description:
      "Get away from it all in this rustic mountain cabin. Perfect for hiking and nature enthusiasts.",
    image:  "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2FtcGluZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
    price: 1800,
